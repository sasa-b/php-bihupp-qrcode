...
final readonly class Lines implements \IteratorAggregate, \ArrayAccess, \Countable
{
    ...
    {
        if ($this->lines[11] instanceof PaymentReference) {
            $paymentReference = $this->lines[11]->value !== '' ? $this->lines[11] : null;
        } else {
        ...
        return new PaymentInstruction(
            sender: new Sender(
                ...
                account: $this->lines[4] instanceof Account ? $this->lines[4] : new Account(''),
                phoneNumber: $this->lines[5] instanceof PhoneNumber ? $this->lines[5] : null,
            ),
            recipient: new Recipient(
                name: $this->lines[6] instanceof Name ? $this->lines[6] : new Name(''),
                address: new Address(
                    addressLine1: $this->lines[7] instanceof AddressLine1 ? $this->lines[7] : new AddressLine1(''),
                    addressLine2: $this->lines[8] instanceof AddressLine2 ? $this->lines[8] : new AddressLine2(''),
                ),
                account: $this->lines[9] instanceof RecipientAccount ? $this->lines[9] : new RecipientAccount(new Account('')),
            ),
            purpose: $this->lines[10] instanceof PaymentPurpose ? $this->lines[10] : new PaymentPurpose(''),
